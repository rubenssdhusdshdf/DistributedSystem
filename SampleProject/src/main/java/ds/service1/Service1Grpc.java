 ...
 * </pre>
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.15.0)", comments = "Source: service1.proto")
public final class Service1Grpc {
  ...
  // method to use ControlTrafficLightRequest and ControlTrafficLightResponse
  public static io.grpc.MethodDescriptor<ControlTrafficLightRequest, ControlTrafficLightResponse> getControlTrafficLightMethod() {
    io.grpc.MethodDescriptor<ControlTrafficLightRequest, ControlTrafficLightResponse> controlTrafficLightMethod;
    if ((controlTrafficLightMethod = Service1Grpc.controlTrafficLightMethod) == null) {
      synchronized (Service1Grpc.class) {
        if ((controlTrafficLightMethod = Service1Grpc.controlTrafficLightMethod) == null) {
          Service1Grpc.controlTrafficLightMethod = controlTrafficLightMethod = io.grpc.MethodDescriptor
              .<ControlTrafficLightRequest, ControlTrafficLightResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "service1.Service1", "ControlTrafficLight"))
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlTrafficLightRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ControlTrafficLightResponse.getDefaultInstance()))
              .setSchemaDescriptor(new Service1MethodDescriptorSupplier("ControlTrafficLight"))
              .build();
        }
      }
    }

    return controlTrafficLightMethod;
  }

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ds.service1.RequestMessage, ds.service1.ResponseMessage> getService1DoMethod;

  @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
      + "service1_do", requestType = ds.service1.RequestMessage.class, responseType = ds.service1.ResponseMessage.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ds.service1.RequestMessage, ds.service1.ResponseMessage> getService1DoMethod() {
    ...
    if ((getService1DoMethod = Service1Grpc.getService1DoMethod) == null) {
      synchronized (Service1Grpc.class) {
        if ((getService1DoMethod = Service1Grpc.getService1DoMethod) == null) {
          Service1Grpc.getService1DoMethod = getService1DoMethod = io.grpc.MethodDescriptor.<ds.service1.RequestMessage, ds.service1.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
              getService1DoMethod(),
              asyncUnaryCall(
                  new MethodHandlers<ds.service1.RequestMessage, ds.service1.ResponseMessage>(
